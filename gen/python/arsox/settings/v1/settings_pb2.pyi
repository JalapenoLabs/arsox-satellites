...
from arsox.settings.v1 import hook_pb2 as _hook_pb2
...
class ThreadSettings(_message.Message):
    ...
    RELAYED_MCP_SERVERS_FIELD_NUMBER: _ClassVar[int]
    TURN_DEFAULTS_FIELD_NUMBER: _ClassVar[int]
