...
pub struct Turn {
    ...
    pub attachments: ::prost::alloc::vec::Vec<TurnAttachment>,
}
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct TurnEndHookResult {
    /// The hook's declared name.
    #[prost(string, tag="1")]
    pub name: ::prost::alloc::string::String,
    #[prost(enumeration="TurnEndHookOutcome", tag="2")]
    pub outcome: i32,
...
pub struct TurnResult {
    ...
    pub turn_end_hooks: ::prost::alloc::vec::Vec<TurnEndHookResult>,
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
impl Stage {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::TurnEndHooks => "STAGE_TURN_END_HOOKS",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "STAGE_TURN_END_HOOKS" => Some(Self::TurnEndHooks),
            _ => None,
        }
    }
}
...
impl TurnEndHookOutcome {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "TURN_END_HOOK_OUTCOME_UNSPECIFIED",
            Self::Succeeded => "TURN_END_HOOK_OUTCOME_SUCCEEDED",
            Self::Failed => "TURN_END_HOOK_OUTCOME_FAILED",
            Self::TimedOut => "TURN_END_HOOK_OUTCOME_TIMED_OUT",
            Self::NotLaunched => "TURN_END_HOOK_OUTCOME_NOT_LAUNCHED",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "TURN_END_HOOK_OUTCOME_UNSPECIFIED" => Some(Self::Unspecified),
            "TURN_END_HOOK_OUTCOME_SUCCEEDED" => Some(Self::Succeeded),
            "TURN_END_HOOK_OUTCOME_FAILED" => Some(Self::Failed),
            "TURN_END_HOOK_OUTCOME_TIMED_OUT" => Some(Self::TimedOut),
            "TURN_END_HOOK_OUTCOME_NOT_LAUNCHED" => Some(Self::NotLaunched),
            _ => None,
        }
    }
}
